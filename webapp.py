...
def return_data():
    ...
    graph_title = "\"" + major_selected + ": Work Activity\""
    return render_template('Data-For-Majors.html', major = graph_title, firstfact = salaries(major_selected), secondfact = demographics(major_selected), thirdfact = education_type(major_selected), majorsdata = get_major_options(), graphdata = graph_data(major_selected), graph = Markup('<div id="chartContainer" style="height: 370px; width: 100%;"></div><script src="https://canvasjs.com/assets/script/canvasjs.min.js"></script>'))
