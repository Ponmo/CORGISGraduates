...
def return_data():
    ...
    return render_template('Data-For-Majors.html', major = Markup("\"" + major_selected + ": Work Activity\""), firstfact = salaries(major_selected), secondfact = demographics(major_selected), thirdfact = education_type(major_selected), majorsdata = get_major_options(), graphdata = graph_data(major_selected), graph = Markup('<div id="chartContainer" style="height: 370px; width: 100%;"></div><script src="https://canvasjs.com/assets/script/canvasjs.min.js"></script>'))
...
def data_employment():
    ...
    total = 0.0
    employed_total = 0.0
    dictionary = {1993: "Percent", 1995: "Percent", 1997: "Percent", 1999: "Percent", 2001: "Percent", 2003: "Percent", 2006: "Percent", 2008: "Percent", 2010: "Percent", 2013: "Percent", 2015: "Percent"}
    ...
    for year in dictionary:
        ...
        employment_data += Markup("{ x: new Date(" + str(year) + "), y: " + str(employed_total/total) + " },")
        total = 0.0
        employed_total = 0.0
